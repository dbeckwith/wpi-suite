...
public class NewDeckPanel extends JPanel {
    ...
    public NewDeckPanel() {
        ...
        createDeckButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                final DeckModel newDeck = new DeckModel(newDeckName.getText()
                        .trim(), cards, multipleSelect.isSelected());
                newDeck.sort();
    ...
    private static String makeNewDeckName() {
        ...
        for (DeckModel deck : (ArrayList<DeckModel>) DeckListModel
                .getInstance().getDecks()) {
