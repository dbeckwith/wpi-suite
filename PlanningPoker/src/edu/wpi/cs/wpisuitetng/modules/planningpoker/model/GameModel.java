...
public class GameModel extends AbstractModel implements Serializable {
	 ...
	 */
	public boolean equals(GameModel other) { // $codepro.audit.disable com.instantiations.assist
		//.eclipse.analysis.audit.rule.effectivejava.obeyEqualsContract.obeyGeneralContractOfEquals
