...
public class AllGamesViewPanel extends javax.swing.JPanel {
    ...
    public AllGamesViewPanel() {
        ...
        emptyDescriptionLabel.setToolTipText("No game is currently selected. Select one from the tree on the left to see information about it or vote on it. If there are no games, create one with the Create Game button above.");
