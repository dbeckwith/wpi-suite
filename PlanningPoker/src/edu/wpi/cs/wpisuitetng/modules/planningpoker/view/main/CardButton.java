...
public class CardButton extends JPanel implements MouseListener, ChangeListener {
    ...
    final private ArrayList<ActionListener> listeners = new ArrayList<ActionListener>();
        ...
        if (isEnabled()) {
            ...
            if(!textInput){
            	...
            	if(maxInput != DeckModel.NO_LIMIT){
            		g2.setColor(Color.BLACK);
            		final String maxString = "Max : "+ cardFormat.format(((SpinnerNumberModel)input.getModel()).getMaximum());
